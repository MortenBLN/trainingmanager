...
namespace Trainingsmanager.Migrations
{
    ...
    [Migration("20250526125244_UpdateUrlInSessionNotRequired")]
    partial class UpdateUrlInSessionNotRequired
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Trainingsmanager.Database.Models.Subscription", b =>
                {
                    ...
                    b.HasOne("Trainingsmanager.Database.Models.AppUser", "User")
                        .WithMany("Subscriptions")
